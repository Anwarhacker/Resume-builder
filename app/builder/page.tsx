...
type TemplateType = "modern" | "minimalist" | "professional" | "creative" | "executive" | "classic" | "monochrome"

const templates = {
  modern: { name: "Modern", component: ModernTemplate, description: "Clean design with gradient header" },
  minimalist: { name: "Minimalist", component: MinimalistTemplate, description: "Simple and elegant layout" },
  professional: { name: "Professional", component: ProfessionalTemplate, description: "Corporate-style formatting" },
  creative: { name: "Creative", component: CreativeTemplate, description: "Colorful with unique elements" },
  executive: { name: "Executive", component: ExecutiveTemplate, description: "Bold black & white executive style" },
  classic: { name: "Classic", component: ClassicTemplate, description: "Traditional centered layout" },
  monochrome: { name: "Monochrome", component: MonochromeTemplate, description: "Tech-focused monospace design" },
}
...
export default function BuilderPage() {
  ...
  const updateWorkExperience = useCallback((workExperience: ResumeData["workExperience"]) => {
  ...
  const updateCertificates = useCallback((certificates: ResumeData["certificates"]) => {
  ...
  const SelectedTemplateComponent = useMemo(() => templates[selectedTemplate].component, [selectedTemplate])
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-lg sm:text-xl font-serif font-bold">Resume Builder</h1>
              </div>
            </div>
          ...
          {isPreviewMode ? (
            ...
            >
              <div className="text-center mb-6">
                <h2 className="text-xl sm:text-2xl font-serif font-bold mb-2">Resume Preview</h2>
                <p className="text-muted-foreground">Template: {templates[selectedTemplate].name}</p>
              </div>
              <div className="bg-white border border-border rounded-lg overflow-hidden shadow-lg">
                <div data-resume-template>
                  <AnimatedTemplatePreview templateKey={selectedTemplate}>{renderTemplate()}</AnimatedTemplatePreview>
                </div>
              </div>
            </motion.div>
          ) : (
              ...
              <div className="space-y-4 sm:space-y-6">
                <AnimatedFormSection>
                  <div className="text-center lg:text-left">
                    <h2 className="text-xl sm:text-2xl font-serif font-bold mb-2">Build Your Resume</h2>
                ...
                <AnimatedFormSection delay={0.1}>
                  <Tabs defaultValue="personal" className="w-full">
                    <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 h-auto gap-1 p-1">
                      <TabsTrigger value="personal" className="text-xs sm:text-sm px-1 sm:px-2 py-2 whitespace-nowrap">
                        Personal
                      </TabsTrigger>
                      <TabsTrigger
                        value="experience"
                      ...
                      <TabsTrigger value="education" className="text-xs sm:text-sm px-1 sm:px-2 py-2 whitespace-nowrap">
                        Education
                      </TabsTrigger>
                      <TabsTrigger value="projects" className="text-xs sm:text-sm px-1 sm:px-2 py-2 whitespace-nowrap">
                        Projects
                      </TabsTrigger>
                      <TabsTrigger value="skills" className="text-xs sm:text-sm px-1 sm:px-2 py-2 whitespace-nowrap">
                        Skills
                      </TabsTrigger>
                      <TabsTrigger
                        value="certificates"
                      ...
                      <TabsTrigger value="hobbies" className="text-xs sm:text-sm px-1 sm:px-2 py-2 whitespace-nowrap">
                        Hobbies
                      </TabsTrigger>
                    </TabsList>
                    ...
                    <TabsContent value="projects" className="space-y-4 mt-4">
                      <ProjectsForm projects={resumeData.projects} onChange={updateProjects} />
                    </TabsContent>
                    ...
                    <TabsContent value="hobbies" className="space-y-4 mt-4">
                      <HobbiesForm hobbies={resumeData.hobbies} onChange={updateHobbies} />
                    </TabsContent>
                  </Tabs>
                </AnimatedFormSection>
              </div>
                  ...
                  <Card className="p-3 sm:p-6">
                    <div className="text-center mb-4 sm:mb-6">
                      <div className="flex items-center justify-center gap-2 mb-2">
                        ...
                        <h3 className="text-base sm:text-lg font-serif font-semibold">Live Preview</h3>
                      </div>
                      <motion.p
