        ...
        <div className="flex justify-between items-start">
          <div className="flex-1">
            {personalInfo.summary && (
              <p className="text-sm leading-relaxed text-blue-100 max-w-2xl">{personalInfo.summary}</p>
            )}
          </div>
          <div className="ml-8 space-y-1 text-sm">
            {personalInfo.email && <div className="flex items-center"><span className="w-4 text-blue-200">✉</span> {personalInfo.email}</div>}
            {personalInfo.phone && <div className="flex items-center"><span className="w-4 text-blue-200">☎</span> {personalInfo.phone}</div>}
            {personalInfo.location && <div className="flex items-center"><span className="w-4 text-blue-200">📍</span> {personalInfo.location}</div>}
            {personalInfo.linkedin && <div className="flex items-center"><span className="w-4 text-blue-200">💼</span> {personalInfo.linkedin}</div>}
          </div>
        </div>
      </div>
        ...
        {hasContent(workExperience) && (
          <div className="mb-8">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-xl font-light text-gray-800">Professional Experience</h2>
                ...
                <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      ...
                      <div className="text-blue-600 font-medium">{work.company}</div>
                    </div>
          ...
          {hasContent(skills) && (
            <div className="col-span-2">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-xl font-light text-gray-800">Skills & Expertise</h2>
              ...
              <div className="grid grid-cols-2 gap-6">
                {Object.entries(
                  ...
                  <div key={category} className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="text-sm font-semibold text-gray-800 mb-3 border-b border-gray-200 pb-2">{category}</h4>
            ...
            {hasContent(education) && (
              <div>
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-light text-gray-800">Education</h3>
                </div>
                {education.map((edu) => (
                  <div key={edu.id} className="bg-purple-50 p-4 rounded-lg mb-3 border-l-4 border-purple-600">
            ...
            {hasContent(certificates) && (
              <div>
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-light text-gray-800">Certifications</h3>
                </div>
                {certificates.map((cert) => (
                  <div key={cert.id} className="bg-orange-50 p-3 rounded-lg mb-3 border-l-4 border-orange-600">
        ...
        {hasContent(projects) && (
          <div className="mt-8">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-xl font-light text-gray-800">Featured Projects</h2>
              <div className="flex-1 ml-4 border-t border-red-200"></div>
            </div>
            
            <div className="grid grid-cols-2 gap-6">
              {projects.map((project) => (
                <div key={project.id} className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-lg shadow-sm border">
                  <div className="flex justify-between items-start mb-3">
                  ...
                  {project.description && <p className="text-sm text-gray-700 mb-4">{project.description}</p>}
        ...
        {hasContent(hobbies) && (
          <div className="mt-8">
            ...
            <div className="flex flex-wrap gap-3">
              {hobbies.map((hobby) => (
                <span key={hobby.id} className="px-4 py-2 bg-indigo-100 text-indigo-800 text-sm rounded-full border border-indigo-200">
                  {hobby.name}
                </span>
              ))}
            </div>
