                        ...
                        project.technologies.length > 0 && (
                          <div className="flex flex-wrap gap-2">
                            {project.technologies.map((tech, index) => (
                              <span
                                key={index}
                                className="px-3 py-1 bg-gradient-to-r from-blue-100 to-blue-50 text-blue-800 text-xs font-medium rounded-full border border-blue-200"
                              >
                                {tech}
                              </span>
                            ))}
            ...
            {hasContent(education) && (
              <div>
                ...
                {education.map((edu) => (
                  <div
                    key={edu.id}
                    className="mb-4 p-4 bg-slate-50 rounded-lg border-l-4 border-slate-600"
                  >
            ...
            {hasContent(certificates) && (
              <div>
                ...
                {certificates.map((cert) => (
                  <div
                    key={cert.id}
                    className="mb-3 p-3 bg-gradient-to-r from-slate-50 to-slate-100 rounded-lg"
                  >
